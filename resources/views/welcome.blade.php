                    ...
                    <div class="col-xxl-6 col-xl-7 col-lg-6">
                        <div class="bd-demo-banner-content">
                            ...
                            <div class="demo-banner-btn smooth mt-40 wow fadeInUp" data-wow-delay=".6s">
                                <a class="bd-btn-primary" href="{{url('register')}}">Register Now<i class="fa-regular fa-arrow-down"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="recent-news-wrapper">
                            ...
                            <div class="recent-news-box">
                                <div class="post-added-content">
                                    <div class="product-cat-title"><a href="{{route('welcome/info',$list->id)}}">{{$list->faculty->name}}</a></div>
