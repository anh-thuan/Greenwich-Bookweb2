    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form action="{{url('coordinator/contribution/zipfile')}}" method="POST">
                    @csrf
                                ...
                                <table id="tech-companies-1" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td><a href="{{route('studentinfo/showfile', ['contribution' => $post]) }}">{{ $post->upload_file }}</a></td>
