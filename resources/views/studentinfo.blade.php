                ...
                <div class="row g-40 align-items-center">
                    ...
                    <div class="col-lg-7">
                        <div class="about-content">
                            <div class="product-cat-title"><a href="#">{{$welcomeinfo->faculty->name}}</a></div>
                            ...
                            <a href="{{url('register')}}"><button class="subscribe-btn learn_btn">Register Now<i class="fa-regular fa-angle-right"></i></button></a>
                        </div>
                    </div>
                </div>
            </div>
