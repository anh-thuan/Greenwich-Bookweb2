		...
		<div class="leftside-menu">
		    ...
		    <div data-simplebar>
		        <ul class="side-nav">
					...
					<!--Class-->
					@canany(['faculty/list', 'faculty/add'])
		            <li class="side-nav-item">
					...
					<li class="side-nav-item">
		                ...
		                <div class="collapse" id="sidebarForms">
		                    <ul class="side-nav-second-level">
		                        ...
		                        <li class="side-nav-item">
		                            <a class="side-nav-link" href="{{url('student/contribution/list')}}">Contribution List</a>
		                        </li>
								@endcan
		                    </ul>
		                </div>
					...
					<li class="side-nav-item">
		                ...
		                <div class="collapse" id="sidebarTables">
		                    <ul class="side-nav-second-level">
								...
								@can('allpost/list')
		                        <li class="side-nav-item">
		                            <a class="side-nav-link" href="{{url('management/allpost/list')}}">My Post</a>
		                        </li>
								@endcan
		                    </ul>
		                </div>
