                                    ...
                                    <h6 class="fs-15 mt-3"><strong>Module {{ucfirst($moduleName)}}</strong></h6>
                                        ...
                                        <div class="mt-2">
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input" id="{{$permission->slug}}" value="{{$permission->id}}" name="permission_id[]" id="{{$permission->slug}}">
                                                <label class="form-check-label" for="{{$permission->slug}}">{{$permission->slug}}</label>
                                            </div>
                                        </div>
                                        @endforeach
                                    @endforeach
